//6880354581:AAHV9v2cH08Fs0g0GODRUZSuVG8e8_2CqVE
const TelegramBot = require('node-telegram-bot-api');


const Vn_go_1p = require("./Vn_go_1p");
const Vn_go_3p = require("./Vn_go_3p");
const Vn_go_5p = require("./Vn_go_3p");
const Vn_go_10p = require("./Vn_go_10p");
const TrxHash = require("./trxhash_1p")

const D5_go_1p = require("./5d_go_1p");
const D5_go_3p = require("./5d_go_3p");
const D5_go_5p = require("./5d_go_3p");
const D5_go_10p = require("./5d_go_10p");
// replace the value below with the Telegram token you receive from @BotFather
const K3_go_1p = require("./k3_go_1p");
const K3_go_3p = require("./k3_go_3p");
const K3_go_5p = require("./k3_go_3p");
const K3_go_10p = require("./k3_go_10p");
const token = '6880354581:AAHV9v2cH08Fs0g0GODRUZSuVG8e8_2CqVE';
    ...
    if (type == 'group') {
        if (text) {
            ...
            if (check == '/' ) {
                ...
                return adminGroup.admingroup(chatId, msg, text, bot, messageId)
            }
        }
        return
