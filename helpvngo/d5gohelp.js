...
<code style="color:blue">/ADD 5D-Go 3</code> <i>để chọn thêm xổ số 5D-Go thời gian 3 phút cho lệnh copy</i>
<code style="color:blue">/STOP 5D-Go 3</code> <i>để chọn dừng xổ số 5D-Go thời gian 3 phút cho lệnh copy</i>`, {
            reply_to_message_id: messageId,
            reply_markup: replyMarkup,
            parse_mode: "HTML"
        })
...
<b>Ví dụ:</b> <code style="color:blue">/CT 1 5D-Go 1</code> <i>để chọn công thức 1 xổ 5D-Go thời gian 1 phút</i>
              <code style="color:blue">/CT 1 5D-Go 3</code> <i>để chọn công thức 1 xổ 5D-Go thời gian 3 phút</i>
              <code style="color:blue">/CT 1 5D-Go 5</code> <i>để chọn công thức 1 xổ 5D-Go thời gian 5 phút</i>
              <code style="color:blue">/ADD 5D-Go 3</code> <i>để chọn thêm xổ 5D-Go thời gian 3 phút cho công thức đang chọn</i>
              <code style="color:blue">/STOP 5D-Go 3</code> <i>để chọn dừng xổ 5D-Go thời gian 3 phút cho công thức đang chọn</i>
