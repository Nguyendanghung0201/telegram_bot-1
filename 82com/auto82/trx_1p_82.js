...
async function test(bot) {
    ...
    try {
        let data = await axios.post("https://82vn82vnapi.com/api/webapi/GetTRXGameIssue", {
            typeid: 13,
            language: "vi"
        }, {
...
async function check_dk(issuenumber, bot) {
    ...
    try {
        let list = []
      let list_lich_su = await axios.post("https://82vn82vnapi.com/api/webapi/GetTRXNoaverageEmerdList", {
        typeid: 13,
        pageno: 1,
        language: "vi"
    }, {
