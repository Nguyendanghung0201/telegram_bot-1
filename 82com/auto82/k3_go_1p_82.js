...
async function test(bot) {
    ...
    try {
        let data = await axios.post("https://82vn82vnapi.com/api/webapi/GetGameIssueList", {
            type: 3,
            language: "vi"
        }, {
...
async function check_dk(issuenumber, bot) {
    ...
    try {
        ...
        let list_lich_su = await axios.post("https://82vn82vnapi.com/api/webapi/GetNoaverageK3EmerdList", {
            typeid: 9,
            pageno: 1,
            language: "vi"
        }, {
